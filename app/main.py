    ...
    if TELEGRAM_CHAT_ID:
        add_recurring_daily_job(
            ...
            message=(
                ...
                f"Step 2: Send the user a single warm, brief morning message that asks:\n"
                f"  1. How did they sleep? (quality and how rested they feel)\n"
                f"  2. Did they complete their morning routine? (list the specific habits/steps "
                f"     from their profile — e.g. cold shower, meditation, journaling, etc.)\n"
                f"  3. What are their main plans or priorities for today?\n"
                f"Keep it concise — one message. Do not call get_oura_data.\n"
                ...
                f"- If they share sleep, mood, or energy info, save it to their profile using update_user_profile."
            ),
        )
